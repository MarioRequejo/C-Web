...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        { 
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", BLL.Formatacao.SemFormatacao(cliente.CPF)));
        ...
        internal bool VerificarExistencia(string CPF)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", BLL.Formatacao.SemFormatacao(CPF)));
        ...
        private List<DML.Cliente> Converter(DataSet ds)
        {
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    ...
                    cli.CPF = BLL.Formatacao.FormataCPF(row.Field<string>("CPF"));
                    lista.Add(cli);
                }
            }
